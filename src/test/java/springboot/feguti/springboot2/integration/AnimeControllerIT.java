package springboot.feguti.springboot2.integration;
...
import springboot.feguti.springboot2.util.AnimePostRequestBodyCreator;
import springboot.feguti.springboot2.wrapper.PageableResponse;
...
class AnimeControllerIT {
    ...
    @Autowired
    private FeGutiUserRepository feGutiUserRepository;
    private static final FeGutiUser USER = FeGutiUser.builder()
            .name("Pipoca")
    ...
    private static final FeGutiUser ADMIN = FeGutiUser.builder()
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("EL macho", "homura");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("feguti", "homura");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound(){
        feGutiUserRepository.save(USER);
    ...
    void delete_RemovesAnime_WhenSuccessful(){
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        feGutiUserRepository.save(ADMIN);
